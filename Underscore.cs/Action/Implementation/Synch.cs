...
namespace Underscore.Action
{
    public class SynchComponent : ISynchComponent
    {
        ...
        {
            return _funcConvert.ToAction( _fnSynch.Once(_actionConvert.ToFunction(action)));
        }
        ...
        {
            return _fnSynch.After(_actionConvert.ToFunction(action), count);
        }
        ...
        {
            return _funcConvert.ToAction(_fnSynch.Before(_actionConvert.ToFunction(action),count));
        }
