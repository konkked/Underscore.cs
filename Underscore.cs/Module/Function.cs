...
namespace Underscore.Module
{
        ...
        ICacheComponent
    {
        ...
        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, Func<T11, Func<T12, Func<T13, Func<T14, Func<T15, TResult>>>>>>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, Func<T11, Func<T12, Func<T13, Func<T14, TResult>>>>>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, Func<T11, Func<T12, Func<T13, TResult>>>>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, Func<T11, Func<T12, TResult>>>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, Func<T11, TResult>>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, Func<T10, TResult>>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, Func<T9, TResult>>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, Func<T8, TResult>>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, T8, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, Func<T7, TResult>>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, T7, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, T7, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, Func<T6, TResult>>>>>>> Splay<T0, T1, T2, T3, T4, T5, T6, TResult>( Func<T0, T1, T2, T3, T4, T5, T6, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, Func<T5, TResult>>>>>> Splay<T0, T1, T2, T3, T4, T5, TResult>( Func<T0, T1, T2, T3, T4, T5, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, Func<T4, TResult>>>>> Splay<T0, T1, T2, T3, T4, TResult>( Func<T0, T1, T2, T3, T4, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, Func<T3, TResult>>>> Splay<T0, T1, T2, T3, TResult>( Func<T0, T1, T2, T3, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, Func<T2, TResult>>> Splay<T0, T1, T2, TResult>( Func<T0, T1, T2, TResult> target )
        {
            return _split.Splay( target );
        }

        public Func<T0, Func<T1, TResult>> Splay<T0, T1, TResult>( Func<T0, T1, TResult> target )
        {
            return _split.Splay( target );
        }
        ...
        {
            return _synch.After(count, function);
        }
        ...
        {
            return _synch.Before(count, function);
        }
