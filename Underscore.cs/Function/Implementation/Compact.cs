...
namespace Underscore.Function
{
    public class CompactComponent : ICompactComponent
    {
        ...
        ///  Creates a new Function bound to the passed parameter
        /// </summary>
		public Func<Tuple<T1 , T2 , T3 , T4 , T5>, TResult> Pack<T1, T2, T3, T4, T5, TResult>( Func<T1, T2, T3, T4, T5, TResult> function )
		{
			return  a => function( a.Item1,a.Item2,a.Item3,a.Item4,a.Item5 );
		}
        ...
        ///  Creates a new Function bound to the passed parameter
        /// </summary>
		public Func<Tuple<T1 , T2 , T3 , T4 , T5 , T6>, TResult> Pack<T1, T2, T3, T4, T5, T6, TResult>( Func<T1, T2, T3, T4, T5, T6, TResult> function )
		{
			return  a => function( a.Item1,a.Item2,a.Item3,a.Item4,a.Item5,a.Item6 );
		}
        ...
        ///  Creates a new Function bound to the passed parameter
        /// </summary>
		public Func<Tuple<T1 , T2 , T3 , T4 , T5 , T6 , T7>, TResult> Pack<T1, T2, T3, T4, T5, T6, T7, TResult>( Func<T1, T2, T3, T4, T5, T6, T7, TResult> function )
		{
			return  a => function( a.Item1,a.Item2,a.Item3,a.Item4,a.Item5,a.Item6,a.Item7 );
		}
