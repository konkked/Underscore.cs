...
namespace Underscore.Function
{
    public interface ICompactComponent
    {
        ...
        ///  Creates a new Function with the parameters packed into a single object
        /// </summary>
		Func<Tuple<T1 , T2 , T3 , T4 , T5>, TResult> Pack<T1, T2, T3, T4, T5, TResult>( Func<T1, T2, T3, T4, T5, TResult> function );
		
				
		/// <summary>
        ///  Creates a new Function with the parameters packed into a single object
        /// </summary>
		Func<Tuple<T1 , T2 , T3 , T4 , T5 , T6>, TResult> Pack<T1, T2, T3, T4, T5, T6, TResult>( Func<T1, T2, T3, T4, T5, T6, TResult> function );
		
				
		/// <summary>
        ///  Creates a new Function with the parameters packed into a single object
        /// </summary>
		Func<Tuple<T1 , T2 , T3 , T4 , T5 , T6 , T7>, TResult> Pack<T1, T2, T3, T4, T5, T6, T7, TResult>( Func<T1, T2, T3, T4, T5, T6, T7, TResult> function );
