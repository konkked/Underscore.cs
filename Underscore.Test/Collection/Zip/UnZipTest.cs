...
namespace Underscore.Test.Collection.Zip
{
	...
	public class UnZipTest
	{
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_2Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            var zipped = _.Collection.Zip(toZipA, toZipB);
            var result = zipped.UnZipFromTuples();
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_3Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            int[] toZipC = { 3, 4, 5, 6, 7, 8 };
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_4Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            int[] toZipC = { 3, 4, 5, 6, 7, 8 };
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_5Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            int[] toZipC = { 3, 4, 5, 6, 7, 8 };
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_6Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            int[] toZipC = { 3, 4, 5, 6, 7, 8 };
        ...
        [Test]
        public void CollectionExtensions_Zip_UnZip_7Arguments()
        {
            int[] toZipA = { 1, 2, 3, 4, 5, 6 };
            int[] toZipB = { 2, 3, 4, 5, 6, 7 };
            int[] toZipC = { 3, 4, 5, 6, 7, 8 };
